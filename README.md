...
| [logo](skills/logo/) | Designs a mark through reference study, generated concept rounds, and a browsable contact sheet showing every candidate at 16px — the size that actually decides a logo. Bakes real typeface outlines to SVG paths | `npx skills add oharu121/skills/logo` |
