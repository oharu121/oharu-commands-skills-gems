...
If the repo has no `format:check` script in `package.json`, skip the format check step and note it.

## On Failure

Use AskUserQuestion:
- "Lint/format/tests failed. How do you want to proceed?"
...
State: "npm lint, format check, and tests passed." and continue to Phase 2.
