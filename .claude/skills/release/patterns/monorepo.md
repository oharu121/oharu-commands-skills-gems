# Pre-flight Pattern: monorepo

**Summary for Phase 0 announcement:** per-package pre-flight for each changed package.
...
### 2. Run pre-flight per changed package
...
Use AskUserQuestion:
- "Pre-flight failed in \<package\>. How do you want to proceed?"
- Options: "Fix first (cancel release)", "Skip failed package and continue", "Skip all pre-flight"

## On Full Pass

State: "All package pre-flights passed." and continue to Phase 2.
